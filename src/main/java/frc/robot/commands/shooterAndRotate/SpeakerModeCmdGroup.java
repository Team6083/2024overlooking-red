...
public class SpeakerModeCmdGroup extends SequentialCommandGroup {
  /** Creates a new SpeakerMode. */
  public SpeakerModeCmdGroup(RotateShooterSubsystem rotateShooterSubsystem, ShooterSubsystem shooterSubsystem) {

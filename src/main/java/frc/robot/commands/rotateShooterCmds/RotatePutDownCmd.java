...
public class RotatePutDownCmd extends Command {
  /** Creates a new RotatePutDown. */
  RotateShooterSubsystem rotateShooterSubsystem;
  public RotatePutDownCmd(RotateShooterSubsystem rotateShooterSubsystem) {
  ...
  public void initialize() {
    rotateShooterSubsystem.setSetpoint(0);
  }

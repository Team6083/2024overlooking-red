...
public class riseReManual extends Command {
  /** Creates a new riseReManual. */
    private final RiseShooterSubsystem riseShooterSubsytem;
  public riseReManual(RiseShooterSubsystem riseShooterSubsystem) {
